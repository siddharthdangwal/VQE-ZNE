...
loss_filename = parent_folder + molecule_folder_name + 'zne_th_' + str(zne_th) + '_seed_' + seed +  '_losses_.csv'
params_filename = parent_folder + molecule_folder_name + 'zne_th_' + str(zne_th) + '_seed_' + seed +  '_params_.csv'
